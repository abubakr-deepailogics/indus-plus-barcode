...
export default function OpenOrderPage() {
  ...
  // Work Order (set by Cut Report, Coupon Generation or Coupon Tracing) on
  // mount, and propagates a search committed here to the other pages.
  ...
  }, [activeSearchQuery, cutDetails, styleBulletins, user]);
                ...
                <DataTable
                  ...
                  csv={{
                    ...
                    columns: [
                      {
                        header: "Sequence",
                        accessor: (row) => row.Operation_Sequence,
                      },
                      {
                        header: "Op Code",
                        accessor: (row) => row.Operation_Code,
                      },
                      {
                        header: "Op Name",
                      ...
                      {
                        header: "Piece Rate",
                        accessor: (row) => row.Piece_Rate,
                      },
                      { header: "SMV / SAM", accessor: (row) => row.Smv_Sam },
                      {
                        header: "Machine Type",
                        accessor: (row) => row.Machine_Type,
                      },
                      {
                        header: "Bi Hourly TGT",
                        accessor: (row) => row.Bi_Hourly_Tgt,
                      },
                      { header: "Shift TGT", accessor: (row) => row.Shift_Tgt },
                      {
                        header: "# of Operations",
                        accessor: (row) => row.No_Of_Operations,
                      },
