...
export default function OpenOrderPage() {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    if (e.key === "Escape") {
      ...
      // Style Bulletin search is autocomplete-only: free text that doesn't
      // match a real Order No must not trigger a search (an empty field is
      // still allowed through, to let the user clear the current results).
      const match = trimmed
