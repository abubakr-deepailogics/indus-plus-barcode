...
const mockBarcodeStyles: BarcodeStyleData[] = [
  {
    ...
    total: "170,000",
    operations: [
      { id: 1, section: "500 - PRE FINISHING", seqNo: "1", opNo: "1", operationName: "LOOP CUTTING-6", smv: "3.00", rate: "0.35", skills: "Skilled", lastOpSection: false },
      { id: 2, section: "501 - FINISHING", seqNo: "2", opNo: "2", operationName: "REINFORCEMENT PATCH TRIMMING - 08", smv: "3.00", rate: "0.42", skills: "Skilled", lastOpSection: false },
      { id: 3, section: "502 - PACKING", seqNo: "3", opNo: "3", operationName: "(WATCH PKT EDGE TRIM)-01", smv: "3.00", rate: "0.12", skills: "Semi-Skilled", lastOpSection: false },
      { id: 4, section: "", seqNo: "4", opNo: "32523", operationName: "POCKET BAG WASHING SERVICE STITCH", smv: "3.00", rate: "0.35", skills: "Skilled", lastOpSection: false },
      { id: 5, section: "", seqNo: "5", opNo: "29864", operationName: "FRONT POCKET CLEAN WITH PRESSURE", smv: "3.00", rate: "0.18", skills: "Un-Skilled", lastOpSection: false },
      { id: 6, section: "", seqNo: "6", opNo: "32526", operationName: "TAG PINS REMOVE-02", smv: "3.00", rate: "0.24", skills: "Un-Skilled", lastOpSection: false }
    ],
    bundles: [
      { id: 1, transId: "T0002451", line: "1", bundleNo: "B0001", inseam: "32.29", size: "28", pcs: 85, sel: true, code: "A01" },
      { id: 2, transId: "T0002451", line: "2", bundleNo: "B0002", inseam: "32.29", size: "30", pcs: 85, sel: true, code: "A01" },
      { id: 3, transId: "T0002451", line: "3", bundleNo: "B0003", inseam: "32.29", size: "32", pcs: 85, sel: true, code: "A01" },
      { id: 4, transId: "T0002451", line: "4", bundleNo: "B0004", inseam: "32.29", size: "34", pcs: 85, sel: true, code: "A01" },
      { id: 5, transId: "T0002451", line: "5", bundleNo: "B0005", inseam: "32.29", size: "36", pcs: 85, sel: true, code: "A01" },
      { id: 6, transId: "T0002452", line: "1", bundleNo: "B0006", inseam: "34.29", size: "28", pcs: 85, sel: true, code: "A01" }
    ]
  },
  {
    anlNo: "38920",
    ...
    total: "127,500",
    operations: [
      { id: 1, section: "500 - PRE FINISHING", seqNo: "1", opNo: "101", operationName: "HAND SCRAPING FRONT", smv: "4.50", rate: "0.60", skills: "Skilled", lastOpSection: false },
      { id: 2, section: "501 - FINISHING", seqNo: "2", opNo: "102", operationName: "WHISKERING EFFECT", smv: "5.00", rate: "0.85", skills: "Skilled", lastOpSection: false }
    ],
    bundles: [
      { id: 1, transId: "T0008892", line: "3", bundleNo: "B0024", inseam: "30.00", size: "32", pcs: 50, sel: true, code: "C02" },
      { id: 2, transId: "T0008892", line: "4", bundleNo: "B0025", inseam: "30.00", size: "34", pcs: 50, sel: true, code: "C02" }
    ]
  },
  {
    anlNo: "90412",
    ...
    total: "85,000",
    operations: [
      { id: 1, section: "500 - PRE FINISHING", seqNo: "1", opNo: "201", operationName: "HOOD RIB ATTACH", smv: "2.10", rate: "0.30", skills: "Semi-Skilled", lastOpSection: false },
      { id: 2, section: "502 - PACKING", seqNo: "2", opNo: "202", operationName: "FOLDING & POLY BAG", smv: "1.20", rate: "0.15", skills: "Un-Skilled", lastOpSection: false }
    ],
    bundles: [
      { id: 1, transId: "T0009124", line: "1", bundleNo: "B0109", inseam: "0.00", size: "M", pcs: 100, sel: true, code: "F01" },
      { id: 2, transId: "T0009124", line: "2", bundleNo: "B0110", inseam: "0.00", size: "L", pcs: 100, sel: true, code: "F01" }
    ]
  }
];
...
function encodeCode128B(text: string): string {
  const widths = [
    ...
    "214121", "412121", "111143", "111341", "113141", "111431", "113411", "114131", "114311", "411131", // 90-99
    "411311", "113114", "111413", "113113", "113311", "411113", "411311"
  ];
  const startB = 104;
...
export default function BarcodeGenerationFinishingPage() {
  const [activeStyle, setActiveStyle] = useState<BarcodeStyleData>(mockBarcodeStyles[0]);
    ...
    <>
      ...
      <div className="flex items-center justify-between border-b border-[#e2e8f0] pb-3">
        <div className="flex items-center gap-2 text-xs font-semibold text-[#64748b]">
          ...
          <span className="text-[#4f46e5] font-bold">Barcode Generation Finishing</span>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-5 items-end">
        ...
        <div className="lg:col-span-10 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">ANL#</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Customer</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Style Code</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Total Wash</label>
            <input
              type="text"
              value={activeStyle.totalWash}
              onChange={(e) => setActiveStyle({ ...activeStyle, totalWash: e.target.value })}
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] font-semibold"
            />
          </div>

          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Generate By</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Generate Datetime</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Balance</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1.5">
              <label className="font-bold text-[#475569] text-[10px] uppercase">Generated Coupons</label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="font-bold text-[#475569] text-[10px] uppercase">Generated Bundle</label>
              <input
                type="text"
          ...
          <div className="md:col-span-4 flex flex-col gap-1.5">
            <label className="font-bold text-[#475569] text-[11px]">Notes</label>
            <input
              type="text"
              value={activeStyle.notes}
              onChange={(e) => setActiveStyle({ ...activeStyle, notes: e.target.value })}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-2">
        ...
        <div className="lg:col-span-6 bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm flex flex-col gap-4">
            ...
            <table className="w-full text-left border-collapse min-w-[500px]">
              <thead>
                <tr className="border-b border-[#e2e8f0]">
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Section</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Seq #</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Op #</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Operation</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">SMV</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Rate</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Skills</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Last Op Section</th>
                </tr>
              </thead>
                  ...
                  <tr key={op.id} className="hover:bg-[#f8fafc] transition-colors">
                    ...
                    <td className="py-2 text-center">
                      <input
                        ...
                        onChange={(e) => {
                          const updated = activeStyle.operations.map((o) => o.id === op.id ? { ...o, lastOpSection: e.target.checked } : o);
                          setActiveStyle({ ...activeStyle, operations: updated });
                        }}
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-[#f1f5f9] pt-4 mt-1">
            <div className="flex flex-col gap-1.5">
              <label className="font-bold text-[#475569] text-[11px]">Remarks</label>
              <input
                type="text"
                value={activeStyle.remarks}
                onChange={(e) => setActiveStyle({ ...activeStyle, remarks: e.target.value })}
            ...
            <div className="flex flex-col gap-1.5 w-32 self-end">
              <label className="font-bold text-[#475569] text-[11px]">Rework Qty</label>
              <input
                type="text"
                value={activeStyle.reworkQtyMain}
                onChange={(e) => setActiveStyle({ ...activeStyle, reworkQtyMain: e.target.value })}
                className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] text-center"
              />
            </div>
          </div>
        ...
        <div className="lg:col-span-6 bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between border-b border-[#f1f5f9] pb-2">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[11px] font-bold text-[#64748b]">Complete selection</span>
              <input
                type="checkbox"
                defaultChecked
                className="rounded border-[#e2e8f0] text-[#4f46e5]"
          ...
          <div className="flex items-center gap-3 py-0.5">
            ...
            <div className="flex items-center gap-1">
              <input
                ...
                onChange={(e) => setActiveStyle({ ...activeStyle, reworkQtyBundle: e.target.value })}
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[500px]">
              <thead>
                <tr className="border-b border-[#e2e8f0]">
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Trans Id</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Line</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Bundle #</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Inseam</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Size</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Pcs</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">Sel</th>
                  <th className="py-2 text-[10px] font-bold text-[#64748b] uppercase tracking-wider">Code</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#f1f5f9]">
                  ...
                  <tr key={bd.id} className="hover:bg-[#f8fafc] transition-colors">
                    ...
                    <td className="py-2 text-center">
                      <input
                        ...
                        checked={bd.sel}
                        onChange={(e) => {
                          const updated = activeStyle.bundles.map((b) => b.id === bd.id ? { ...b, sel: e.target.checked } : b);
                          setActiveStyle({ ...activeStyle, bundles: updated });
                        }}
                        className="rounded border-[#e2e8f0] text-[#4f46e5]"
                      />
                    </td>
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-[#f8fafc] border-t border-[#e2e8f0] px-6 py-2.5 flex items-center justify-between text-[11px] text-[#64748b] font-semibold z-35">
        <div>
          Record: <span className="text-[#334155]">1/1</span> | Choices in list: <span className="text-[#334155]">1</span> | Choices in full list: <span className="text-[#334155]">36863</span>
        </div>
        <div>
        ...
        <div className="fixed inset-0 bg-[#0f172a]/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl border border-[#e2e8f0] max-w-[500px] w-full p-6 animate-scale-up">
            <div className="flex items-center justify-between border-b border-[#f1f5f9] pb-4 mb-4">
              <h3 className="text-sm font-extrabold text-[#0f172a]">Select ANL# Style</h3>
              <button
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                    <th className="px-4 py-2.5 text-[10px] font-bold text-[#64748b] uppercase tracking-wider w-24">ANL No</th>
                    <th className="px-4 py-2.5 text-[10px] font-bold text-[#64748b] uppercase tracking-wider w-28">Customer</th>
                ...
                <tbody>
                  {filteredStyles.map((style) => (
                    <tr
                      key={style.anlNo}
                      onClick={() => setSelectedIdx(mockBarcodeStyles.indexOf(style))}
                      className={`hover:bg-indigo-50/30 cursor-pointer transition-colors ${
                        selectedIdx === mockBarcodeStyles.indexOf(style) ? "bg-indigo-50/50" : ""
                      }`}
                    >
                      <td className="px-4 py-3 flex items-center gap-2.5 text-xs font-semibold text-[#334155]">
                        <input
                          type="radio"
                          checked={selectedIdx === mockBarcodeStyles.indexOf(style)}
                          onChange={() => setSelectedIdx(mockBarcodeStyles.indexOf(style))}
                  ...
                  {filteredStyles.length === 0 && (
                    <tr>
                      <td colSpan={3} className="text-center py-4 text-[#94a3b8]">No styles found</td>
                    </tr>
                  )}
                </tbody>
              </table>
            ...
            <div className="flex items-center justify-between border-t border-[#f1f5f9] pt-4">
              <span className="text-[11px] text-[#94a3b8] font-semibold">{filteredStyles.length} results found</span>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-[#e2e8f0] max-w-[500px] w-full p-6 animate-scale-up text-xs text-[#334155] font-sans">
              ...
              <div className="relative w-36 h-44 bg-white border border-gray-300 rounded-md shadow-md flex items-center justify-center p-2">
                <div 
                  ...
                  style={{
                    ...
                    transform: pageSetup.orientation === 'Landscape' ? 'rotate(-90deg)' : 'none',
            ...
            <div className="mb-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-[#4f46e5] text-[11px] uppercase tracking-wider">Paper</span>
              ...
              <div className="grid grid-cols-1 gap-3 pl-6">
                <div className="flex items-center justify-between">
                  ...
                  <select 
                    ...
                    onChange={(e) => setPageSetup({ ...pageSetup, size: e.target.value })}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select 
                    ...
                    onChange={(e) => setPageSetup({ ...pageSetup, source: e.target.value })}
                    className="flex-1 max-w-[280px] px-3 py-2 rounded-xl border border-[#e2e8f0] bg-white font-semibold text-gray-700 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 mb-6">
              ...
              <div className="md:col-span-5 border border-gray-100 rounded-2xl p-4 bg-gray-50/30">
                <div className="flex items-center gap-1.5 mb-3">
                  <span className="font-bold text-[#4f46e5] text-[11px] uppercase tracking-wider">Orientation</span>
                </div>
                <div className="flex flex-col gap-2.5 pl-1">
                  <label className="flex items-center gap-2 cursor-pointer font-bold text-gray-700">
                    <input 
                      ...
                      onChange={() => setPageSetup({ ...pageSetup, orientation: 'Portrait' })}
                  ...
                  <label className="flex items-center gap-2 cursor-pointer font-bold text-gray-700">
                    <input 
                      ...
                      onChange={() => setPageSetup({ ...pageSetup, orientation: 'Landscape' })}
                      className="text-[#4f46e5] focus:ring-indigo-500"
                    />
                    <span>Landscape</span>
                  </label>
              ...
              <div className="md:col-span-7 border border-gray-100 rounded-2xl p-4 bg-gray-50/30">
                <div className="flex items-center gap-1.5 mb-3">
                  ...
                  <span className="font-bold text-[#4f46e5] text-[11px] uppercase tracking-wider">Margins (inches)</span>
                </div>
                <div className="grid grid-cols-2 gap-x-4 gap-y-2.5">
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-bold text-gray-500 text-[10px]">Left</span>
                    <input 
                      type="number" 
                      step="0.001"
                      value={pageSetup.margins.left}
                      onChange={(e) => setPageSetup({ 
                        ...pageSetup, 
                        margins: { ...pageSetup.margins, left: parseFloat(e.target.value) || 0 } 
                      })}
                      className="w-16 px-1.5 py-1 text-center border border-[#e2e8f0] rounded-lg font-bold"
                    />
                  </div>
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-bold text-gray-500 text-[10px]">Right</span>
                    <input 
                      type="number" 
                      step="0.001"
                      ...
                      onChange={(e) => setPageSetup({ 
                        ...pageSetup, 
                        margins: { ...pageSetup.margins, right: parseFloat(e.target.value) || 0 } 
                      })}
                      className="w-16 px-1.5 py-1 text-center border border-[#e2e8f0] rounded-lg font-bold"
                    />
                  </div>
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-bold text-gray-500 text-[10px]">Top</span>
                    <input 
                      type="number" 
                      step="0.001"
                      ...
                      onChange={(e) => setPageSetup({ 
                        ...pageSetup, 
                        margins: { ...pageSetup.margins, top: parseFloat(e.target.value) || 0 } 
                      })}
                      className="w-16 px-1.5 py-1 text-center border border-[#e2e8f0] rounded-lg font-bold"
                    />
                  </div>
                  <div className="flex items-center justify-between gap-1">
                    <span className="font-bold text-gray-500 text-[10px]">Bottom</span>
                    <input 
                      type="number" 
                      step="0.001"
                      ...
                      onChange={(e) => setPageSetup({ 
                        ...pageSetup, 
                        margins: { ...pageSetup.margins, bottom: parseFloat(e.target.value) || 0 } 
                      })}
                      className="w-16 px-1.5 py-1 text-center border border-[#e2e8f0] rounded-lg font-bold"
                    />
                  </div>
