    ...
    <div className="flex flex-col gap-6 max-w-[1380px] mx-auto text-xs text-[#334155] animate-fade-in relative pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/"
            className="flex items-center gap-1.5 bg-[#4f46e5] hover:bg-[#4338ca] text-white px-4 py-2 rounded-xl font-bold transition-all shadow-sm"
          >
        ...
        <div className="lg:col-span-3 bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex gap-1">
              <input
                ...
                onChange={facade.handleAMNumberChange}
              ...
              />
              <button
                onClick={facade.openSearchModal}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              onChange={facade.handleStyleDropdownChange}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) => facade.updateField("planQty", e.target.value)}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) =>
                facade.updateField("description", e.target.value)
              }
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) =>
                facade.updateField("styleDescription", e.target.value)
              }
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              onChange={(e) =>
                facade.updateField("styleCategory", e.target.value)
              }
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            >
        ...
        <div className="lg:col-span-2 bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) => facade.updateField("smdNo", e.target.value)}
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) => facade.updateField("finalSmdNo", e.target.value)}
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
        </div>
        ...
        <div className="lg:col-span-3 bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm flex flex-col gap-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                onChange={(e) => facade.updateField("target", e.target.value)}
                className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
              />
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                onChange={(e) =>
                  facade.updateField("targetUnitMin", e.target.value)
                }
                className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
              />
            </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  facade.updateField("startTime", e.target.value)
                }
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) => facade.updateField("pqcAm", e.target.value)}
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={(e) =>
                facade.updateField("pqcPieceRate", e.target.value)
              }
              className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
            />
          </div>
          ...
          <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm grid grid-cols-3 gap-3">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                onChange={(e) => facade.updateField("headReqd", e.target.value)}
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                onChange={(e) => facade.updateField("totalSam", e.target.value)}
                className="w-full px-3 py-2 border border-[#e2e8f0] rounded-xl bg-[#f8fafc] text-xs focus:outline-none"
              />
            </div>
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                onChange={(e) =>
                  facade.updateField("totalRate", e.target.value)
                }
                className="w-full px-3 py-2 border border-[#e2e8f0] rounded-xl bg-[#f8fafc] text-xs focus:outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      facade.updateField("appDate", e.target.value)
                    }
                    className="w-full px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
                  />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  onChange={(e) => facade.updateField("appBy", e.target.value)}
                  className="px-3 py-2 rounded-xl border border-[#e2e8f0] text-xs bg-[#f8fafc] focus:outline-none"
                >
          ...
          <table className="w-full text-left border-collapse min-w-[1450px]">
            <thead>
              <tr className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[155px]">
                  Section
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center w-12">
                  Seq
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[105px]">
                  Seq #Op No
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[170px]">
                  <span className="inline-block w-2 h-2 rounded-full bg-[#6366f1] mr-1"></span>
                  Op Name
                </th>
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center w-12">
                  SM
                </th>
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center w-12">
                  SAM
                ...
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center w-20">
                  Incentive %
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[145px]">
                  MC Type
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[110px]">
                  Folder
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center w-24">
                  Actions
                </th>
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">
                  Attachment
                </th>
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">
                  M/Cs @ 100%
                </th>
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">
                  M/Cs @ Pin EFF%
                ...
                <th className="px-3 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider min-w-[90px]">
                  Last Op
                </th>
                <th className="px-2 py-3 text-[10px] font-bold text-[#64748b] uppercase tracking-wider text-center">
                  Ref./del.
            ...
            <tbody className="divide-y divide-[#f1f5f9]">
              {activeData.operations.map((row) => (
                ...
                >
                  ...
                  <td className="px-2 py-2">
                    <select className="w-full px-2 py-1.5 rounded-lg border border-[#e2e8f0] bg-white text-xs focus:outline-none">
                      <option value={row.opNo}>
                        {row.opNo || "Select OpNo"}
                      </option>
                    </select>
                  </td>
                  <td className="px-2 py-2">
                  ...
                  <td className="px-2 py-2 text-center">
                    {"attachedFileName" in row && row.attachedFileName ? (
                      <div className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 px-2 py-1 rounded-lg font-semibold text-[10px] border border-emerald-200 max-w-[120px]">
                        ...
                        <button
                          onClick={() => facade.handleRemoveAttachment(row.id)}
                      ...
                      <label className="inline-flex items-center gap-1 bg-[#f8fafc] border border-[#e2e8f0] text-[#64748b] px-2 py-1 rounded-lg font-semibold hover:bg-white hover:text-[#0f172a] transition-all text-[11px] cursor-pointer">
                        ...
                        <input
                          type="file"
                          className="hidden"
                          onChange={(e) => facade.handleAttachFile(e, row.id)}
                        />
                      </label>
                    )}
                  </td>
      ...
      <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm mt-3 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
        ...
        <div className="md:col-span-9">
          <textarea
            ...
            onChange={(e) => facade.updateField("remarks", e.target.value)}
